...
public class RaidResultPanel : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        {
            case 1: trophies[index].GetTrophy(goldTrophy, LiveIcon, "¿‘»˘ «««ÿ∑Æ"); bonous += 3; break;
            case 2: trophies[index].GetTrophy(silverTrophy, LiveIcon, "¿‘»˘ «««ÿ∑Æ"); bonous += 2; break;
            case 3: trophies[index].GetTrophy(bronzeTrophy, LiveIcon, "¿‘»˘ «««ÿ∑Æ"); bonous += 1; break;
        }
        index++;
