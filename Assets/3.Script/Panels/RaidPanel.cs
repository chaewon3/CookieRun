...
public class RaidPanel : MonoBehaviourPunCallbacks
{
    ...
    //todo : ÀÌ°Åµµ ÇÃ·¹ÀÌ¾îÀÇ ´ëÇ¥ÄíÅ° µ¥ÀÌÅÍ°¡ ¿©±â·Î µé¾î¿Àµµ·Ï SOX Data
    ...
    public void Start()
    { //todo : ÄíÅ°¸®½ºÆ®ºÎÅÍ ¸¸µé°í °Å±â¼­ °¡Á®¿Í¾ßÇÒµí?
    ...
    public override void OnJoinedRoom()
    {
        ...
        gameRoomRefresh();
        // ¹æ¿¡ ÀÔÀåÇßÀ» ¶§, ¹æÀåÀÇ ¾À ·Îµå ¿©ºÎ¿¡ µû¶ó ÇÔ²² ¾À ·Îµå
    ...
    public override void OnJoinRoomFailed(short returnCode, string message)
    {
        switch(returnCode)
        {
            case 32766: errorMsg.text = "ÆÄÆ¼°¡ °¡µæ Ã¡½À´Ï´Ù."; break;
            default: errorMsg.text = "ÀÏÄ¡ÇÏ´Â ÆÄÆ¼°¡ ¾ø½À´Ï´Ù."; break;
        }
    }
